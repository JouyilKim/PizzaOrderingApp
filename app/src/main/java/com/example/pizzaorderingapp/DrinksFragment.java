...
public class DrinksFragment extends Fragment {
    ...
    private String[] drinksNames= {"coke.png", "sprite.png", "L&P.png"};
    private int buttonChecked=0;
    private String [][] itemList = new String[drinksNames.length][2];
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loadProducts.execute(UrlSettings.searchProducts + "?productType=drinks");
        ...
        protected void onPostExecute(String jsonValue) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    setLayout(productName, productPrice, drinksNames[i]);
                }
